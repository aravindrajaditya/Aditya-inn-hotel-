...
function App() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section style="position: relative; height: 40vh; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-top: 2.5rem; width: 100%;" className="relative h-screen flex items-center justify-center overflow-hidden mt-16">
